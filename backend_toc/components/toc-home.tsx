...
export default function TocHome() {
  ...
  const { squads, alarms, setAlarms, photos, setPhotos, statusMessage, setStatusMessage, loadLive } = useLiveFeed(
    supabase,
    orgId,
      ...
      <div className={styles.workspace}>
        <div className={styles.opsGrid}>
          ...
          <section className={styles.opsColumn}>
            ...
            <p className={styles.opsColumnHint}>Messaggi dal campo. Le foto si aprono e si salvano in LOG.</p>
            <div className={styles.opsColumnBody}>
